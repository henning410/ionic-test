...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">testApp documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            <li class="link">
                                <a href="components/AddWallboxPage.html" data-type="entity-link" >AddWallboxPage</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/MapPage.html" data-type="entity-link" >MapPage</a>
                            </li>
                            <li class="link">
                                <a href="components/OsmMap2Page.html" data-type="entity-link" >OsmMap2Page</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/Step2Component.html" data-type="entity-link" >Step2Component</a>
                            </li>
                            <li class="link">
