...
export class OsmMap2Page implements OnInit, OnChanges {
  ...
  loadMap() {
    ...
    const json: FeatureCollection = {
      ...
      "features": [{
        "bbox": [8.436021, 48.692806, 9.275281, 49.420538], "type": "Feature", "properties": {
          "segments": [{
            "distance": 138952.5,
            "duration": 5526.6,
            "steps": [{
  ...
  setPopupConfig(event: any) {
    console.log('HUHU', event.target._latlng.lat);
    this.component.instance.name = event.target._latlng.lat;
